...
import com.example.tripfactory_concierge_android.adapter.MessageRVAdapter;
import com.example.tripfactory_concierge_android.entity.Message;
...
public class VoucherActivity extends AppCompatActivity  {
        ...
        sendMsgIB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userMsgEdt.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(VoucherActivity.this, "Please enter your message..", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void sendMessage(String userMsg) {
        ...
        String url = "http://api.brainshop.ai/get?bid=172628&key=j61qMEYZRIjFpwti&uid=msandeepcip@gmail.com&msg=" + userMsg;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(VoucherActivity.this, "No response from the bot..",Toast.LENGTH_SHORT).show();
            }
        });
