package com.example.tripfactory_concierge_android.firebase

import android.app.Activity
import android.util.Log
import android.widget.Toast
import com.example.tripfactory_concierge_android.activity.RegisterActivity
...
import com.example.tripfactory_concierge_android.ui.activities.*
        ...
        mFireStore
            ...
            .addOnSuccessListener {
                ...
                if(activity is RegisterActivity)
                    activity.showErrorSnackBar(it.message.toString())
        ...
        mFireStore
            ...
            .addOnSuccessListener { document ->
                ...
                when(activity){
                    ...
                    is SplashActivity -> activity.signInSuccess(loggedInUser)
            ...
            .addOnFailureListener {
                when(activity){
                    ...
                    is SplashActivity -> activity.signInSuccess(null)
                    is MainActivity -> activity.hideProgressDialog()
                    is MyProfileActivity -> activity.hideProgressDialog()
                }
